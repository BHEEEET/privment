    ...
    return (
        <div className="w-full max-w-md bg-white shadow-md rounded-xl p-8">
            ...
            <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 py-2 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
                <svg
                    className="w-5 h-5"
            ...
            <form className="space-y-5" action={handleFormSubmit}>
                ...
                <div className="flex gap-3">
                    <button
                        formAction={login}
                        disabled={isLoading}
                        className="w-1/2 py-2 bg-black text-white rounded-lg text-sm font-medium hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Log in
                    </button>
                    <button
                        formAction={signup}
                        disabled={isLoading}
                        className="w-1/2 py-2 border border-black text-black rounded-lg text-sm font-medium hover:bg-black hover:text-white transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Sign up
                    </button>
                </div>
